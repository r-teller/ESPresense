...
created: 2026-03-21
changelog:
  - 1.1.0 (2026-05-01): Register scribe-refine as agent #2 (paired with scribe-init); update unclear-intent question.
...
### 2. `scribe-refine`
- When the user wants to promote backlog beads to triage:ready by inlining PRD/spec content into the bead body. Just-in-time enrichment before claim.
- Keywords: refine, enrich, promote, triage, ready, inline spec, bead body, work-item-templates, triage:backlog, triage:triaged.
...
> "Do you want project setup, bead enrichment, a PRD/requirements doc, an executive brief, or a planning session?"
